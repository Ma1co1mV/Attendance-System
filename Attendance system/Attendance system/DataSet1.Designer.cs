...
namespace Attendance_system {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class AttendanceRecordsDataTable : global::System.Data.TypedTableBase<AttendanceRecordsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AttendanceRecordsRow AddAttendanceRecordsRow(int RecNum, int StudentID, int ClassID, System.DateTime DateAtt, string Status, string StudentName, string ClassName) {
        ...
        public partial class AttendanceRecordsRow : global::System.Data.DataRow {
            ...
            public System.DateTime DateAtt {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableAttendanceRecords.DateAttColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'DateAtt\' in table \'AttendanceRecords\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAttendanceRecords.DateAttColumn] = value;
                }
            }
            ...
            public bool IsDateAttNull() {
                return this.IsNull(this.tableAttendanceRecords.DateAttColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetDateAttNull() {
                this[this.tableAttendanceRecords.DateAttColumn] = global::System.Convert.DBNull;
            }
...
SELECT StudentID, StudentName, ClassID FROM Students WHERE (StudentID = @StudentID)";
    ...
    public partial class AttendanceRecordsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [AttendanceRecords] ([StudentID], [ClassID], [DateAtt], [Status], [St" +
                "udentName], [ClassName]) VALUES (@StudentID, @ClassID, @DateAtt, @Status, @Stude" +
                "ntName, @ClassName)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StudentID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StudentID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ClassID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ClassID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [AttendanceRecords] SET [StudentID] = @StudentID, [ClassID] = @ClassID, [DateAtt] = @DateAtt, [Status] = @Status, [StudentName] = @StudentName, [ClassName] = @ClassName WHERE (([RecNum] = @Original_RecNum) AND ((@IsNull_StudentID = 1 AND [StudentID] IS NULL) OR ([StudentID] = @Original_StudentID)) AND ((@IsNull_ClassID = 1 AND [ClassID] IS NULL) OR ([ClassID] = @Original_ClassID)) AND ((@IsNull_DateAtt = 1 AND [DateAtt] IS NULL) OR ([DateAtt] = @Original_DateAtt)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_StudentName = 1 AND [StudentName] IS NULL) OR ([StudentName] = @Original_StudentName)) AND ((@IsNull_ClassName = 1 AND [ClassName] IS NULL) OR ([ClassName] = @Original_ClassName)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StudentID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StudentID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ClassID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ClassID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "Select COUNT(Status) from AttendanceRecords\r\nwhere MONTH(DateAtt) = @Month and St" +
                "udentName= @Student and Status= @Status";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [AttendanceRecords] ([StudentID], [ClassID], [DateAtt], [Status], [St" +
                "udentName], [ClassName]) VALUES (@StudentID, @ClassID, @DateAtt, @Status, @Stude" +
                "ntName, @ClassName)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1Report(DataSet1.AttendanceRecordsDataTable dataTable, decimal Month, string Student, string Status) {
        ...
        public virtual int UpdateQuery(string Status, string StudentName, global::System.Nullable<int> ClassID, string date) {
